...
//Pin assignments
int motor = 33;
int handlebarbutton = 23;
int readylight = 32;
int ziplight = 26;        // ziplight to 11
int recoverylight = 27;    //recoveryled to 12
...
// LED flashing
int f_led = 3000; // LED oscilation frequency in Hz
...
// 2 crossing trigger.
int upper_threshold = 2000; // TODO get real values
int lower_threshold = 1000; // TODO get real values
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if(menu == 1){
              ...
              client.println(".button2 {background-color: #e62117;}</style></head>");
              //client.println(".button3 {background-color: #e62117;}</style></head>");
              ...
              if (output26State=="off") {
                ...
                client.println("<p><a href=\"/26/off\"><button class=\"button button2\">FORWARD</button></a></p>");
              } 
                
              // Display current state, and ON/OFF buttons for GPIO 27  
              //client.println("<p>Stop - State " + output27State + "</p>");
              ...
              if (output28State == "auto") {
                ...
                client.println("<p><a href=\"/28/off\"><button class=\"button button2\">AUTO</button></a></p>");
              } 
            ...
            if(menu = 2){
              ...
              //String IRstring = string(currentIr);
              ...
              client.println("<p>Upper Threshold: <span id=\"uppperPos\"></span></p>");          
              ...
              client.println("$.ajaxSetup({timeout:1000}); function ma(pos2) { ");
              client.println("$.get(\"/?value3=\" + pos2 + \"&\"); {Connection: close};}</script>");

              client.println("</body></html>");
              
              client.println("<p><a href=\"/menu2/off\"><button class=\"button button2\">Menu 1</button></a></p>");

              if(header.indexOf("GET /?value2=")>=0) {
                lower1 = header.indexOf('=');
                lower2 = header.indexOf('&');
                upperThreshold = header.substring(lower1+1, lower2);
              ...
              else if (header.indexOf("GET /menu2/off") >= 0) {
                menu = 1;
              }
